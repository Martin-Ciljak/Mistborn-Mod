...
import net.chilly.mistbornmod.worldgen.ModBiomeModifiers;
import net.chilly.mistbornmod.worldgen.ModConfiguredFeatures;
import net.chilly.mistbornmod.worldgen.ModPlaceFeatures;
...
public class ModDatapackProvider extends DatapackBuiltinEntriesProvider {
    ...
    public ModDatapackProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> registries) {
        super(output, registries, BUILDER, Set.of(MistbornMod.MOD_ID));
    }
}
