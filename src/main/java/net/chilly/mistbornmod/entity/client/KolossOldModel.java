...
public class KolossOldModel<T extends KolossEntity> extends KolossModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(MistbornMod.MOD_ID, "koloss_old"), "main");
	...
	public KolossOldModel(ModelPart root) {
		super();
