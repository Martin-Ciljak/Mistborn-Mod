...
public class GeckoEntity extends Animal {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(3, new TemptGoal(this, 1.25, itemStack -> itemStack.is(ModItems.FRUITS), false));
    ...
    public boolean isFood(ItemStack stack) {
        return stack.is(ModItems.FRUITS.get());
    }
    ...
    public AgeableMob getBreedOffspring(ServerLevel level, AgeableMob otherParent) {
        ...
        if (random.nextInt(0, 2) == 0) {
            ...
            baby.setVariant(((GeckoEntity) otherParent).getVariant());
        }
        return baby;
    }
