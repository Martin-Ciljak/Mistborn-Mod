...
public class ModFoodProperfies {
    ...
    public static final FoodProperties BARLEY = new FoodProperties.Builder().nutrition(1).saturationModifier(0.1f).fast().build();
    public static final FoodProperties COOKED_BARLEY = new FoodProperties.Builder().nutrition(3).saturationModifier(0.3f).fast().build();
    public static final FoodProperties FRUITS = new FoodProperties.Builder().nutrition(2).saturationModifier(0.2f).fast().build();
}
