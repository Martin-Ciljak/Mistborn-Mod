...
public class MistbornMod {
    ...
    @EventBusSubscriber(modid = MistbornMod.MOD_ID, bus = EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
    static class ClientModEvents {
        ...
        static void onClientSetup(FMLClientSetupEvent event) {
            ...
            EntityRenderers.register(ModEntities.BOXING.get(), BoxingProjectileRenderer::new);
